...
export default function DectoHex() {
  function decToHexConvert()
  {
    ...
    document.querySelector('.textOutput').value = num.toString(16);
  }
  ...
  return (
    <>
        ...
        <h3>Decimal to Hex Converter</h3>
          <input type='text' className='textInput' placeholder='Enter Decimal Input' />
          <input type='button' className='convert-Btn' value='Convert' onClick={decToHexConvert} />
