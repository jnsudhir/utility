...
export default function OctaltoHex() {
  function octalToHex()
  {
    var bin = document.querySelector('.textInput').value;
    document.querySelector('.textOutput').value = parseInt(bin , 8).toString(16);
  }
  ...
  return (
    <>
        ...
        <div className="encode-decode">
          ...
          <input type='button' className='convert-Btn' value='Convert' onClick={octalToHex} />
