...
export default function HextoBinary() {
  function hexToBinary()
  {
    ...
    document.querySelector('.textOutput').value = parseInt(bin , 16).toString(2);
  }
  ...
  return (
    <>
        ...
        <h3>Hex to Binary Converter</h3>
          <input type='text' className='textInput' placeholder='Enter Binary Input' />
          <input type='button' className='convert-Btn' value='Convert' onClick={hexToBinary} />
