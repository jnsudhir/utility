Utility App is a combination of multiple tools like IP address, Color Converter, Time Converter etc., built using single page web application called React JS.
